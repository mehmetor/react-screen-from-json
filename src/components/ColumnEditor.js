...
const ColumnEditor = () => {
  ...
  return (
    ...
    >
      ...
      <Column dataField="index" width={60} allowEditing={false} />
      <Column dataField="allowEditing" dataType="boolean" width={60} />
      <Column dataField="required" dataType="boolean" width={60} />
