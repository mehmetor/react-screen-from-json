...
import { DateFormats, LogLevelTypes } from "../data";
import { locale, formatDate } from "devextreme/localization";

const now = new Date();

if (!ScreenConfig.Lists.DateFormats)
	ScreenConfig.Lists.DateFormats = DateFormats

if (!ScreenConfig.Lists.LogLevelTypes)
	ScreenConfig.Lists.LogLevelTypes = LogLevelTypes
